...
export async function POST(req: NextRequest) {
  try {
    ...
    if (contentType.includes("multipart/form-data")) {
      ...
      if (formatParam && ['javascript', 'json-schema', 'typescript', 'python'].includes(formatParam)) {
      ...
      if (body.format && ['javascript', 'json-schema', 'typescript', 'python'].includes(body.format)) {
